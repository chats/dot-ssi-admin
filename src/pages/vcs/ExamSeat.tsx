...
const ExamSeat: React.FC = () => {
    ...
    const sendCredentialOffer = async () => {
        setLoading(true);
        const offer = createOffer(connection_id, ExamSeatId, attrs);
        //        console.log(JSON.stringify(offer));
...
*/
    ...
    const setFormValues = () => {
        form.setFieldsValue({
            cid: randomCid(13),
            exam_id: "สอบใบอนุญาตมัคคุเทศก์",
            exam_date: "2024-03-12T13:01:00+0700",
            place: "12 ถนนสาทร แขวงทุ่งมหาเมฆ เขตสาทร กรุงเทพมหานคร 10120",
            room: "ห้องสอบ 4",
            seat: "A-12",
            name: "สมชาย สีงามดี",
            phone: "081-234-5678",
            email: "somchai_si@gmail.com",
        });
    };
    useEffect(() => {
        setFormValues();
